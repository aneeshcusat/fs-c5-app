...
console.log('%cStaff Software Engineer | Enterprise Architect', 'color: #5a7a6e; font-size: 12px;');
console.log('%cPress Ctrl+K (or Cmd+K) to search', 'color: #5a7a6e; font-size: 11px;');
