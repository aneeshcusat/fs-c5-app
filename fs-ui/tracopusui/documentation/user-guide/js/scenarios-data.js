  ...
  global.SCENARIO_GUIDE = {
    ...
    scenarios: [
      ...
      },
      {
        ...
        prerequisites: ['timesheetApprovalEnabled', 'Pending weeks or submission batches in team scope'],
        steps: [
          'Open **Timesheet** or **Workspace → Approvals**.',
          'Locate **Pending approvals** panel.',
          'Select employee week (flag off) or submission batch (flag on).',
          'Review hours and conflicts for that pending unit.',
          ...
          'For payroll lock (if enabled), confirm lock after the week is fully approved.'
        ],
