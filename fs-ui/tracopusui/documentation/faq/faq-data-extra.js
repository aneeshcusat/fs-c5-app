      ...
      items: [
        {
          ...
          a: '<strong>HRMS → Leave Management</strong> — create a request with type, date range, and optional notes. Some orgs also allow leave rows on the timesheet.'
        },
        {
